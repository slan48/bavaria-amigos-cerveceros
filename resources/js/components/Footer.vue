<template>
    <footer class="bg-gray text-primary">
        <div class="container px-15px lg:px-30px flex justify-center lg:justify-between items-center py-15px lg:py-8px flex-wrap lg:flex-no-wrap">
            <div class="inline-flex lg:w-6/12 lg:flex items-center justify-center lg:justify-start">
                <div class="border-r border-primary mr-10px pr-10px w-50px">
                    <img class="block w-full" src="/img/icons/icon-bavaria-red.svg" alt="">
                </div>
                <div class="block lg:flex items-center flex-wrap lg:flex-no-wrap">
                    <p class="text-12px leading-12px font-bold mr-15px">Orgullosamente<br>parte de A-BInBev</p>
                    <p class="text-27px leading-32px font-bold">TAP INTO YOUR BEER</p>
                </div>
            </div>
